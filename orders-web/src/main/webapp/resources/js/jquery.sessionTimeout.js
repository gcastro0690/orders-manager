...
(function ($) {
    jQuery.sessionTimeout = function (options) {
        ...
        $('body').append('<div title="Advertencia" id="sessionTimeout-dialog">' + o.message + '</div>');        
        ...
        $('#sessionTimeout-dialog').parent().zIndex(15000); //Se agrega para posicionar por encima de todos los dialogos
